 ...
 *
 * MyMessagesHighPriorityMessage, MyMessagesM2MMessage, and
 * MyMessagesHighPriorityMessageHeader cannot be subscribed to at the same time or
 ...
 */
class MyMessagesHighPriorityMessageHeader
{
    use Dispatchable;
