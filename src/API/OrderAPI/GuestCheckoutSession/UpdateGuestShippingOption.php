 ...
 * @see https://developer.ebay.com/api-docs/buy/order/resources/guest_checkout_session/methods/updateGuestShippingOption
 */
class UpdateGuestShippingOption implements BaseAPIRequest
{
    use CommonMethods;
     ...
     * @var string
     */
    public const PATH = '/uy/order/v2/guest_checkout_session/{checkoutSessionId}/update_shipping_option';
