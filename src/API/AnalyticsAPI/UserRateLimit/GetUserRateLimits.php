...
namespace Rat\eBaySDK\API\AnalyticsAPI\UserRateLimit;
 ...
 */
class GetUserRateLimits implements BaseAPIRequest
{
    use CommonMethods;
     ...
     * @var string
     */
    public const PATH = '/developer/analytics/v1_beta/user_rate_limit';
