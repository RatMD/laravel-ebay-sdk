 ...
 * @see https://developer.ebay.com/devzone/xml/docs/Reference/eBay/GetVeROReasonCodeDetails.html
 */
class GetVeROReasonCodeDetails implements TraditionalAPIRequest
{
