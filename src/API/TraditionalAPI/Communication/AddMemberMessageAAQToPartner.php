 ...
 * @see https://developer.ebay.com/devzone/xml/docs/Reference/eBay/AddMemberMessageAAQToPartner.html
 */
class AddMemberMessageAAQToPartner implements TraditionalAPIRequest
{
