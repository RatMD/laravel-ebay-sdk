 ...
 * @see https://developer.ebay.com/devzone/xml/docs/Reference/eBay/AddMemberMessagesAAQToBidder.html
 */
class AddMemberMessagesAAQToBidder implements TraditionalAPIRequest
{
