 ...
 */
class UpdatePromotionalShippingRule implements BaseAPIRequest
{
    use CommonMethods;
     ...
     * @var string
     */
    public const PATH = '/sell/account/v2/combined_shipping_rules/update_promotional_shipping_rule';
