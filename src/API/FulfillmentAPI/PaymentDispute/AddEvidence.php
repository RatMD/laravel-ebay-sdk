...
class AddEvidence implements BaseAPIRequest
{
     ...
     * @var string
     */
    public const PATH = '/sell/fulfillment/v1/payment_dispute/{paymentDisputeId}/add_evidence';
