...
class GetPaymentDispute implements BaseAPIRequest
{
     ...
     * @var string
     */
    public const PATH = '/sell/fulfillment/v1/payment_dispute/{paymentDisputeId}';
