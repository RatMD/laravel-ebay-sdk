...
/**
 * POST /ad_campaign/{campaignId}/bulk_update_keyword
 * @see https://developer.ebay.com/api-docs/sell/marketing/resources/keyword/methods/bulkUpdateKeyword
 */
class BulkUpdateKeyword implements BaseAPIRequest
{
    use CommonMethods;
     ...
     * @var string
     */
    public const PATH = '/sell/marketing/v1/ad_campaign/{campaignId}/bulk_update_keyword';
