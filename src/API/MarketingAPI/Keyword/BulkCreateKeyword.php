...
/**
 * POST /ad_campaign/{campaignId}/bulk_create_keyword
 * @see https://developer.ebay.com/api-docs/sell/marketing/resources/keyword/methods/bulkCreateKeyword
 */
class BulkCreateKeyword implements BaseAPIRequest
{
    use CommonMethods;
     ...
     * @var string
     */
    public const PATH = '/sell/marketing/v1/ad_campaign/{campaignId}/bulk_create_keyword';
