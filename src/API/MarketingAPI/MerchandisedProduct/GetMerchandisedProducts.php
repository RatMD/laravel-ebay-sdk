...
namespace Rat\eBaySDK\API\MarketingAPI\MerchandisedProduct;
 ...
 * @see https://developer.ebay.com/api-docs/buy/marketing/v1/resources/merchandised_product/methods/getMerchandisedProducts
 */
class GetMerchandisedProducts implements BaseAPIRequest
{
     ...
     * @var string
     */
    public const PATH = '/buy/marketing/v1/merchandised_product';
