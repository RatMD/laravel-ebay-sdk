...
class UpdateAdGroup implements BaseAPIRequest
{
     ...
     * @var string
     */
    public const PATH = '/sell/marketing/v1/ad_campaign/{campaignId}/ad_group/{adGroupId}';
