 ...
 */
class GetCompatibilitiesBySpecification implements BaseAPIRequest
{
    use CommonMethods;
     ...
     * @var string
     */
    public const PATH = '/sell/metadata/v1/compatibilities/get_compatibilities_by_specification';
