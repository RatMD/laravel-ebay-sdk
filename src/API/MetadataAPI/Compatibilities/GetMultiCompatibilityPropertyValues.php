 ...
 */
class GetMultiCompatibilityPropertyValues implements BaseAPIRequest
{
    use CommonMethods;
     ...
     * @var string
     */
    public const PATH = '/sell/metadata/v1/compatibilities/get_multi_compatibility_property_values';
