 ...
 */
class GetHazardousMaterialsLabels implements BaseAPIRequest
{
    use CommonMethods;
     ...
     * @var string
     */
    public const PATH = '/sell/metadata/v1/marketplace/{marketplaceId}/get_hazardous_materials_labels';
