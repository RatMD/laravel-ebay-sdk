...
/**
 * GET /marketplace/{marketplaceId}/get_extended_producer_responsibility_policies
 ...
 */
class GetExtendedProducerResponsibilityPolicies implements BaseAPIRequest
{
    use CommonMethods;
     ...
     * @var string
     */
    public const PATH = '/sell/metadata/v1/marketplace/{marketplaceId}/get_extended_producer_responsibility_policies';
