...
/**
 * GET /marketplace/{marketplaceId}/get_listing_type_policies
 * @see https://developer.ebay.com/api-docs/sell/metadata/resources/marketplace/methods/getListingTypePolicies
 */
class GetListingTypePolicies implements BaseAPIRequest
{
    use CommonMethods;
     ...
     * @var string
     */
    public const PATH = '/sell/metadata/v1/marketplace/{marketplaceId}/get_listing_type_policies';
