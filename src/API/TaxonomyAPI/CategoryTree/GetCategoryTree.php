 ...
 * @see https://developer.ebay.com/api-docs/sell/taxonomy/resources/category_tree/methods/getCategoryTree
 */
class GetCategoryTree implements BaseAPIRequest
{
    use CommonMethods;
     ...
     * @var string
     */
    public const PATH = '/commerce/taxonomy/v1/category_tree/{categoryTreeId}';
